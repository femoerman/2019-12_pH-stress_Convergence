...
{
  file_names <- paste(list.files("2_data/14,16,18_EvolutionModelsBayesianContinued/Kmodels/global/", full.names=T))
  ...
  ggplot(data.all, aes(y=exp(log_Kmean), x=pHmediumval, colour=paste(timingval, pHoriginval))) + geom_point()  + 
    ...
    ggtitle("K Model for all strains") + ylab("mean K") + xlab("pH of medium") + 
  ...
  ggsave(plot=last_plot(), filename = "2_data/14,16,18_EvolutionModelsBayesianContinued/r0models/global/plotK.png")
...
#2) Look at CU427.4 models
{
  ...
  posteriorpred <- filter(posteriorpred, !(lowevolved==0 & evolved == 1))
  posteriorpred <- filter(posteriorpred, !(highevolved==0 & evolved == 1))
  
  #1.5) Plot reaction norms
  ggplot(dataCU427.4, aes(y=exp(log_Kmean), x=ifelse(pHmedium==1, 6.5, 5), colour=paste(timing, pHorigin))) + geom_point(size=2)  + 
    ...
    ggtitle("Strain CU427.4") + ylab("Carrying capacity K") + xlab("pH of test-medium") + 
    scale_fill_discrete(name="Origin", breaks=c("ancestral 6.5", "cg 5", "cg 6.5"), labels=c("ancestral", "low-evolved", "high-evolved")) + 
    guides(color = FALSE, size = FALSE)+ theme_light() + 
  ...
  ggsave(plot=last_plot(), filename = "2_data/14,16,18_EvolutionModelsBayesianContinued/Kmodels/CU427.4/Kplot.png")
}
...
#3) Look at B2086.2 models
{
  ...
  #1.5) Plot reaction norms
  ggplot(data.B2086.2, aes(y=exp(log_Kmean), x=ifelse(pHmedium==1, 6.5, 5), colour=paste(timing, pHorigin))) + geom_point(size=2)  + 
    geom_line(data=posteriorpred, inherit.aes = F, aes(x=pHmediumval, y=mean, colour=paste(timingval, pHoriginval)), size=2) + 
    geom_ribbon(data=posteriorpred, inherit.aes = F, aes(ymax=PI97.5, ymin=PI2.5, x=pHmediumval, fill=paste(timingval, pHoriginval)),alpha=0.3) + 
    ggtitle("Strain B2086.2") + ylab("Carrying capacity K") + xlab("pH of test-medium") + 
    scale_fill_discrete(name="Origin", breaks=c("ancestral 6.5", "cg 5", "cg 6.5"), labels=c("ancestral", "low-evolved", "high-evolved")) + 
    guides(color = FALSE, size = FALSE)+ theme_light() + 
    theme(axis.text=element_text(size=20), legend.text=element_text(size=16), strip.text.x=element_text(20),
          axis.title=element_text(size=20), plot.title = element_text(size=20, hjust = 0.5))
  
  ggsave(plot=last_plot(), filename = "2_data/14,16,18_EvolutionModelsBayesianContinued/Kmodels/B2086.2/Kplot.png")
}
...
#4) Look at SB3539 models
{
  ...
  #1.5) Plot reaction norms
  ggplot(data.SB3539, aes(y=exp(log_Kmean), x=ifelse(pHmedium==1, 6.5, 5), colour=paste(timing, pHorigin))) + geom_point(size=2)  + 
    geom_line(data=posteriorpred, inherit.aes = F, aes(x=pHmediumval, y=mean, colour=paste(timingval, pHoriginval)), size=2) + 
    geom_ribbon(data=posteriorpred, inherit.aes = F, aes(ymax=PI97.5, ymin=PI2.5, x=pHmediumval, fill=paste(timingval, pHoriginval)),alpha=0.3) + 
    ggtitle("Strain SB3539") + ylab("Carrying capacity K") + xlab("pH of test-medium") + 
    scale_fill_discrete(name="Origin", breaks=c("ancestral 6.5", "cg 5", "cg 6.5"), labels=c("ancestral", "low-evolved", "high-evolved")) + 
    guides(color = FALSE, size = FALSE)+ theme_light() + 
    theme(axis.text=element_text(size=20), legend.text=element_text(size=16), strip.text.x=element_text(20),
          axis.title=element_text(size=20), plot.title = element_text(size=20, hjust = 0.5))
  
  ggsave(plot=last_plot(), filename = "2_data/14,16,18_EvolutionModelsBayesianContinued/Kmodels/SB3539/Kplot.png")
}
...
#5) Look at CU428.2 models
{
  ...
  #1.5) Plot reaction norms
  ggplot(data.CU428.2, aes(y=exp(log_Kmean), x=ifelse(pHmedium==1, 6.5, 5), colour=paste(timing, pHorigin))) + geom_point(size=2)  + 
    geom_line(data=posteriorpred, inherit.aes = F, aes(x=pHmediumval, y=mean, colour=paste(timingval, pHoriginval)), size=2) + 
    geom_ribbon(data=posteriorpred, inherit.aes = F, aes(ymax=PI97.5, ymin=PI2.5, x=pHmediumval, fill=paste(timingval, pHoriginval)),alpha=0.3) + 
    ggtitle("Strain CU428.2") + ylab("Carrying capacity K") + xlab("pH of test-medium") + 
    scale_fill_discrete(name="Origin", breaks=c("ancestral 6.5", "cg 5", "cg 6.5"), labels=c("ancestral", "low-evolved", "high-evolved")) + 
    guides(color = FALSE, size = FALSE)+ theme_light() + 
    theme(axis.text=element_text(size=20), legend.text=element_text(size=16), strip.text.x=element_text(20),
          axis.title=element_text(size=20), plot.title = element_text(size=20, hjust = 0.5))
  
  ggsave(plot=last_plot(), filename = "2_data/14,16,18_EvolutionModelsBayesianContinued/Kmodels/CU428.2/Kplot.png")
}
